    ...
    if datatype == 'continuous':
        if relationship == 'paired':
            if hypothesis_type == 'greater':
                print(f"H₀: Mean paired difference in {metric} is less than or equal to 0.")
                print(f"H₁: Mean paired difference in {metric} is > 0.")
            elif hypothesis_type == 'less':
                print(f"H₀: Mean paired difference in {metric} is greater than or equal to 0.")
                print(f"H₁: Mean paired difference in {metric} is < 0.")
            else:
                print(f"H₀: Mean paired difference in {metric} is 0.")
            ...
            if len(labels) > 2:
                ...
                print(f"H₀: Mean {metric} in {group2} is greater than or equal to {group1}.")
        ...
        if hypothesis_type == 'greater':
            print(f"H₀: Conversion rate in {group2} is less than or equal to {group1}.")
            print(f"H₁: Conversion rate in {group2} is greater than {group1}.")
        elif hypothesis_type == 'less':
            print(f"H₀: Conversion rate in {group2} is greater than or equal to {group1}.")
